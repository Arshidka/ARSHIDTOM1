...
const asw1 = 'https://ibb.co/d0V866H'
...
const checkRegisteredUser = (sender) => {
    ...
    const ownerNumber = [`918590634460@s.whatsapp.net`]
...
/*const reply = (teks) => {
			xeon.sendMessage(from, teks, text, { thumbnail: iye, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jam} - ${week} ${weton} - ${date}`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/918590634460?text=hello`}}})
		}*/
...
const fakeitem = (teks) => {
        ...
        participant:`0@s.whatsapp.net`, ...(from ? {
remoteJid :"6289523258649-1604595598@g.us" }: {})
                    },message:{"orderMessage":{"orderId":"174238614569481","thumbnail":fs.readFileSync(`./stik/thumb.jpeg`),"itemCount":10,"status":"INQUIRY","surface":"CATALOG","message":`ToM 𝚂𝙸𝚁 😎`,"token":"AR6xBKbXZn0Xwmu76Ksyd7rnxI+Rx87HfinVlW4lwXa6JA=="}}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true})}
// Katalog
const reply = (teks) => {
             res = xeon.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 111119999, "message": teks, "footerText": "*ToM*", "thumbnail": bgg, "surface": 'CATALOG' }}, {quoted:ftrol})
             xeon.relayWAMessage(res)
        }
const fakewa = (teks) => {        
xeon.sendMessage(from, teks, text, { thumbnail: fake, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `ToM`,body:"",previewType:"PHOTO",thumbnail:iye,sourceUrl:`https://wa.me/918590634460?text=hello`}}})
		}
...
sendEphemeral: false,
"externalAdReply": {
                "title": `Whatsapp-BOT\nToM 𝚂𝙸𝚁😎. (@nnda.krnwn_) •Instagram photos and Videos`,
                "body": "",
                "previewType": "PHOTO",
                "thumbnailUrl": "https://ibb.co/d0V866H",
                "thumbnail": fake,
                "sourceUrl": ``
...
"externalAdReply": {
                "title": `Whatsapp`,
                "body": `wa.me/918590634460`,
                "mediaType": "10",
                "mediaUrl": `wa.me/918590634460`,
                "thumbnailUrl": "https://ibb.co/d0V866H",
                "thumbnail": iye,
                "sourceUrl": `wa.me/918590634460`,
...
"mediaType": "2",
"thumbnailUrl": "https://ibb.co/d0V866H",
"mediaUrl": "https://youtube.com/channel/No Nahi",
...
async function sendFileFromUrl(from, url, caption, msg, men) {
    ...
    if (isGroup && !isVote) {
      if (budy.toLowerCase() === "vote") {
        ...
        let id_vote = sender ? sender : "918590634460@s.whatsapp.net";
...
*Thank you for registering in the ToM 𝚂𝙸𝚁😎 Database*
...
*「 ToM SeR 」*`
	    ...
	    // console.log(e)
			...
			reply(`*Thank you for being registered ToM SeR*`)
		}, 2000)
        break
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
       txtt =` ▢ 𝐇𝐢 ${pushname} \n ▢ 𝐆𝐫𝐨𝐮𝐩 𝐂𝐡𝐚𝐭𝐬 : ${groups.length} \n ▢ 𝐏𝐫𝐢𝐯𝐚𝐭𝐞 𝐂𝐡𝐚𝐭𝐬 : ${privat.length}\n ▢ 𝐓𝐨𝐭𝐚𝐥 𝐂𝐡𝐚𝐭𝐬 : ${totalChat.length} \n ▢ 𝐒𝐩𝐞𝐞𝐝 : ${latensie.toFixed(4)} _Second_ \n ▢ 𝐀𝐜𝐭𝐢𝐯𝐞 : ${runtime(process.uptime())} \n ▢ 𝐏𝐥𝐚𝐭𝐟𝐨𝐫𝐦 : ${os.platform()}`
               ...
               buttonsMessage = {
               contentText: `${txtt}`,
               footerText: `ToM SeR`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
prep = await xeon.prepareMessageFromContent(from,{buttonsMessage},{quoted: fkontak})
...
groups = xeon.chats.array.filter(v => v.jid.endsWith('g.us'))
              ...
              total = math(`${groups.length}*${privat.length}`)
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
        ptod = "918590634460@s.whatsapp.net"
        dtod = '918590634460'
        stod = `${sender}`
        uwuu = '```'
        yoii = '*'
...
│
│  ❑ *ɢɪᴛʜᴜʙ ʟɪɴᴋ* :
│  https://github.com/Arshidka/ARSHIDTOM1
│  
│  ❑ *ʏᴏᴜᴛᴜʙᴇ ʟɪɴᴋ* :
│  https://tinyurl.com/nahi
│
│  ❑ *ʙᴏᴛ ɢʀᴏᴜᴘ ʟɪɴᴋ*
│  https://tinyurl.com/nahi
│
...
case 'bugreport':
              ...
              xeon.sendMessage('918590634460@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
...
case 'iggw':
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
  reply('https://www.instagram.com/_mhd_arshid')
break
...
4. 𝙰𝙽𝚈 𝙿𝚁??𝙱𝙻𝙰𝙼 𝙲𝙾𝙽𝚃𝙰𝙲𝚃 𝙾𝚄𝚁 𝙾𝚆𝙽𝙴𝚁
`
sendButMessage(from, menu, `ToM SeR`, [
          {
            buttonId: `command`,
            buttonText: {
...
case 'buglink':
            ...
            "externalAdReply": {
                ...
                "sourceUrl": "https://youtube.com/channel/Nookiyirunno"}}})
                break
        case 'bugbutton':
        if (!isOwner && !mek.key.fromMe) return reply('Only owner can use this feature')
        xeon.toggleDisappearingMessages(from, 0)
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
	 ...
	 case 'delvn':
				...
				case 'listbgm':
					...
					teks += `\n*Tᴏᴛᴀʟ : ${vien.length}*\n\n_▢_`
					xeon.sendMessage(from, teks.trim(), extendedText, { caption: 'teks', "contextInfo": { text: 'teks', sendEphemeral: true, "externalAdReply": { "title": `${' '}𝑷𝒆𝒑𝒆 𝑺𝒆𝒓${''}${''}`, "body": ``, "previewType": 'PHOTO', "thumbnailUrl": `${'https://ibb.co/d0V866H'}`, "thumbnail": '', "sourceUrl": `${'https://wa.me/c/62852407507130'}`}},quoted: ftext})
					break
       case 't3d':
                   if (args.length < 1) return reply(`[  ×  ] Example :\n*${prefix}${command} ToM*`)
                   F = body.slice(5)
...
case 'mygithub':
  reply('╭─➤ *ToM SeR*\n│       ❑  *sᴄʀɪᴘᴛ*\n│❖   ɢɪᴛʜᴜʙ:\n│❖   https://github.com/ToMsir/ToM-SIR\n│❖   ʏᴏᴜᴛᴜʙᴇ:\n│❖   https://youtube.com/channel/NookiyirunnoA\n╰────────────────❋ཻུ۪۪⸙\n\n⌕ ❙❘❙❙❘❙❚❙❘❙❙❚❙❘❙❘❙❚❙❘❙❙❚❙❘❙❙❘❙❚❙❘\n             ToM SeR\n\n╭◪ *ᴄᴏᴅᴅᴇᴅ ʙʏ ᴘᴇᴘᴇ*\n╰─────────────────❋ཻུ۪۪⸙')
					break;
   case 'ss':
      reply(mess.wait)
...
case "intake3": // by ToM
      ...
      case "group":
        if (!mek.key.fromMe) return;
        sendButMessage(from, `GROUP SETTING`, `Please choose one/nToM SeR`, [
          {
            buttonId: `opengc`,
            buttonText: {
              displayText: `OPEN`,
...
buttons = [{buttonId: `writelist`,buttonText:{displayText: `Write List🔖`},type:1}]
              ...
              buttonsMessage = {footerText:'ToM', imageMessage: imageMsg,
   ...
   case 'bc':
      case 'broadcast':
        if (!mek.key.fromMe) return;
             ...
             for (let _ of anu) {
             xeon.sendMessage(_.jid, bc, image, {quoted:fkontak,caption: `*「 ToM BROADCASTING 」*\n\n${body.slice(4)}`})
}
...
ToMx = await fetchJson(`https://bx-hunter.herokuapp.com/api/xvideosearch?query=${c}&apikey=${HunterApi}`)
reply(mess.wait)
ToMx = ToMx.result
ini_txt = ""
for (var x of ToMx) {
...
case 'writelist':
  ...
  ▢ ${prefix}write ToM
  ▢ ${prefix}folioright ToM
  ▢ ${prefix}folioleft ToM
  ▢ ${prefix}writedown ToM
  ▢ ${prefix}writeleft ToM`)
  break
case 'folioleft':
if (!c) return reply('Where is the text bro??')
reply(mess.wait)
...
case 'waifu':
  ...
  break
case 'attp':
              if (args.length == 0) return reply(`Example: ${prefix + command} ToM`)
